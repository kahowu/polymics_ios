...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "Polymics_Portable.iOS.AppDelegate, Polymics_PortableiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "Polymics_Portable.iOS.AppDelegate, Polymics_PortableiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [36].handle = objc_getClass ("UIViewController");
	__monotouch_class_map [37].handle = objc_getClass ("UINavigationController");
	__monotouch_class_map [38].handle = objc_getClass ("UIPickerView");
	__monotouch_class_map [39].handle = objc_getClass ("UIPopoverController");
	...
	__monotouch_class_map [43].handle = objc_getClass ("UIToolbar");
	__monotouch_class_map [44].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [45].handle = objc_getClass ("GLKView");
	__monotouch_class_map [46].handle = objc_getClass ("NSTextAttachment");
	__monotouch_class_map [47].handle = objc_getClass ("UICollectionReusableView");
	__monotouch_class_map [48].handle = objc_getClass ("UICollectionViewCell");
	__monotouch_class_map [49].handle = objc_getClass ("UICollectionViewFlowLayout");
	__monotouch_class_map [50].handle = objc_getClass ("UITextPosition");
	...
	__monotouch_class_map [63].handle = objc_getClass ("UIWebView");
	__monotouch_class_map [64].handle = objc_getClass ("UISplitViewController");
	__monotouch_class_map [65].handle = objc_getClass ("UIStepper");
	__monotouch_class_map [66].handle = objc_getClass ("EAGLContext");
	__monotouch_class_map [67].handle = objc_getClass ("CATransaction");
	__monotouch_class_map [68].handle = objc_getClass ("NSException");
	__monotouch_class_map [69].handle = objc_getClass ("NSNull");
	__monotouch_class_map [70].handle = objc_getClass ("NSIndexSet");
	__monotouch_class_map [71].handle = objc_getClass ("NSNotification");
	__monotouch_class_map [72].handle = objc_getClass ("NSData");
	__monotouch_class_map [73].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [74].handle = objc_getClass ("NSMutableData");
	__monotouch_class_map [75].handle = objc_getClass ("NSNotificationCenter");
	__monotouch_class_map [76].handle = objc_getClass ("__NSObject_Disposer");
	__monotouch_class_map [77].handle = objc_getClass ("MonoTouch_UIKit_UIActionSheet__UIActionSheetDelegate");
	__monotouch_class_map [78].handle = objc_getClass ("UIActionSheet");
	__monotouch_class_map [79].handle = objc_getClass ("MonoTouch_UIKit_UIAlertView__UIAlertViewDelegate");
	__monotouch_class_map [80].handle = objc_getClass ("UIAlertView");
	__monotouch_class_map [81].handle = objc_getClass ("MonoTouch_UIKit_UIBarButtonItem_Callback");
	__monotouch_class_map [82].handle = objc_getClass ("UIBarButtonItem");
	__monotouch_class_map [83].handle = objc_getClass ("__UIGestureRecognizerToken");
	__monotouch_class_map [84].handle = objc_getClass ("__UIGestureRecognizerParameterlessToken");
	__monotouch_class_map [85].handle = objc_getClass ("__UIGestureRecognizerParametrizedToken");
	__monotouch_class_map [86].handle = objc_getClass ("MonoTouch_UIKit_UIGestureRecognizer__UIGestureRecognizerDelegate");
	__monotouch_class_map [87].handle = objc_getClass ("UIGestureRecognizer");
	__monotouch_class_map [88].handle = objc_getClass ("__UILongPressGestureRecognizer");
	__monotouch_class_map [89].handle = objc_getClass ("UILongPressGestureRecognizer");
	__monotouch_class_map [90].handle = objc_getClass ("__UITapGestureRecognizer");
	__monotouch_class_map [91].handle = objc_getClass ("UITapGestureRecognizer");
	__monotouch_class_map [92].handle = objc_getClass ("__UIPanGestureRecognizer");
	__monotouch_class_map [93].handle = objc_getClass ("UIPanGestureRecognizer");
	__monotouch_class_map [94].handle = objc_getClass ("MonoTouch_UIKit_UISearchBar__UISearchBarDelegate");
	__monotouch_class_map [95].handle = objc_getClass ("UISearchBar");
	__monotouch_class_map [96].handle = objc_getClass ("MonoTouch_UIKit_UITextField__UITextFieldDelegate");
	__monotouch_class_map [97].handle = objc_getClass ("UITextField");
	__monotouch_class_map [98].handle = objc_getClass ("MonoTouch_UIKit_UITextView__UITextViewDelegate");
	__monotouch_class_map [99].handle = objc_getClass ("UITextView");
	__monotouch_class_map [100].handle = objc_getClass ("MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate");
	__monotouch_class_map [101].handle = [Xamarin_Forms_Platform_iOS_CellTableViewCell class];
	__monotouch_class_map [102].handle = [Xamarin_Forms_Platform_iOS_ViewRenderer class];
	__monotouch_class_map [103].handle = [Xamarin_Forms_Platform_iOS_NativeRenderer class];
	__monotouch_class_map [104].handle = [Xamarin_Forms_Platform_iOS_ModalWrapper class];
	__monotouch_class_map [105].handle = [Xamarin_Forms_Platform_iOS_PlatformRenderer class];
	__monotouch_class_map [106].handle = [Xamarin_Forms_Platform_iOS_ActivityIndicatorRenderer class];
	__monotouch_class_map [107].handle = [Xamarin_Forms_Platform_iOS_BoxRenderer class];
	__monotouch_class_map [108].handle = [Xamarin_Forms_Platform_iOS_NoCaretField class];
	__monotouch_class_map [109].handle = [Xamarin_Forms_Platform_iOS_EditorRenderer class];
	__monotouch_class_map [110].handle = [Xamarin_Forms_Platform_iOS_FrameRenderer class];
	__monotouch_class_map [111].handle = [Xamarin_Forms_Platform_iOS_LabelRenderer class];
	__monotouch_class_map [112].handle = [Xamarin_Forms_Platform_iOS_ProgressBarRenderer class];
	__monotouch_class_map [113].handle = [Xamarin_Forms_Platform_iOS_ScrollViewRenderer class];
	__monotouch_class_map [114].handle = [Xamarin_Forms_Platform_iOS_SliderRenderer class];
	__monotouch_class_map [115].handle = [Xamarin_Forms_Platform_iOS_StepperRenderer class];
	__monotouch_class_map [116].handle = [Xamarin_Forms_Platform_iOS_SwitchRenderer class];
	__monotouch_class_map [117].handle = [Xamarin_Forms_Platform_iOS_TabbedRenderer class];
	__monotouch_class_map [118].handle = [Xamarin_Forms_Platform_iOS_EventedViewController class];
	__monotouch_class_map [119].handle = objc_getClass ("UITableViewSource");
	__monotouch_class_map [120].handle = [Xamarin_Forms_Platform_iOS_TableViewModelRenderer class];
	__monotouch_class_map [121].handle = [Xamarin_Forms_Platform_iOS_UnEvenTableViewModelRenderer class];
	__monotouch_class_map [122].handle = [Xamarin_Forms_Platform_iOS_ToolbarRenderer class];
	__monotouch_class_map [123].handle = [Xamarin_Forms_Platform_iOS_EntryCellRenderer_EntryCellTableViewCell class];
	__monotouch_class_map [124].handle = [Xamarin_Forms_Platform_iOS_ViewCellRenderer_ViewTableCell class];
	__monotouch_class_map [125].handle = [Xamarin_Forms_Platform_iOS_ToolbarItemExtensions_SecondaryToolBarItem class];
	__monotouch_class_map [126].handle = [Xamarin_Forms_Platform_iOS_ButtonRenderer class];
	__monotouch_class_map [127].handle = [Xamarin_Forms_Platform_iOS_CarouselPageRenderer_PageContainer class];
	__monotouch_class_map [128].handle = [Xamarin_Forms_Platform_iOS_CarouselPageRenderer class];
	__monotouch_class_map [129].handle = [Xamarin_Forms_Platform_iOS_DatePickerRenderer class];
	__monotouch_class_map [130].handle = [Xamarin_Forms_Platform_iOS_EntryRenderer class];
	__monotouch_class_map [131].handle = [Xamarin_Forms_Platform_iOS_ImageRenderer class];
	__monotouch_class_map [132].handle = [Xamarin_Forms_Platform_iOS_ListViewRenderer_ListViewDataSource class];
	__monotouch_class_map [133].handle = [Xamarin_Forms_Platform_iOS_ListViewRenderer class];
	__monotouch_class_map [134].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer_NavigationCell class];
	__monotouch_class_map [135].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer_DataSource class];
	__monotouch_class_map [136].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer_Delegate class];
	__monotouch_class_map [137].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer class];
	__monotouch_class_map [138].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer_SecondaryToolbar class];
	__monotouch_class_map [139].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer_ParentingViewController class];
	__monotouch_class_map [140].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer class];
	__monotouch_class_map [141].handle = [Xamarin_Forms_Platform_iOS_OpenGLViewRenderer_Delegate class];
	__monotouch_class_map [142].handle = [Xamarin_Forms_Platform_iOS_OpenGLViewRenderer class];
	__monotouch_class_map [143].handle = [Xamarin_Forms_Platform_iOS_PageRenderer class];
	__monotouch_class_map [144].handle = [Xamarin_Forms_Platform_iOS_PhoneMasterDetailRenderer class];
	__monotouch_class_map [145].handle = [Xamarin_Forms_Platform_iOS_SearchBarRenderer class];
	__monotouch_class_map [146].handle = [Xamarin_Forms_Platform_iOS_TabletMasterDetailRenderer_InnerDelegate class];
	__monotouch_class_map [147].handle = [Xamarin_Forms_Platform_iOS_TabletMasterDetailRenderer class];
	__monotouch_class_map [148].handle = [Xamarin_Forms_Platform_iOS_TableViewRenderer class];
	__monotouch_class_map [149].handle = [Xamarin_Forms_Platform_iOS_TimePickerRenderer class];
	__monotouch_class_map [150].handle = [Xamarin_Forms_Platform_iOS_WebViewRenderer_CustomWebViewDelegate class];
	__monotouch_class_map [151].handle = [Xamarin_Forms_Platform_iOS_WebViewRenderer class];
	__monotouch_class_map [152].handle = objc_getClass ("UIPickerViewModel");
	__monotouch_class_map [153].handle = [Xamarin_Forms_Platform_iOS_PickerRenderer_PickerSource class];
	__monotouch_class_map [154].handle = [Xamarin_Forms_Platform_iOS_PickerRenderer class];
	monotouch_setup_classmap (__monotouch_class_map, 155);
}
